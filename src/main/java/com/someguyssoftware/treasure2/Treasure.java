 ...
 *
 */
@Mod(modid = Treasure.MODID,
		name = Treasure.NAME,
		version = Treasure.VERSION,
		dependencies = "required-after:gottschcore@[1.14.0,);" +
				"required-after:baubles@[1.5.2,);" +
				"required-after:biomesoplenty@[7.0.1,);" +
				"required-after:undergroundbiomes;" +
				"required-after:dynamictrees;" +
				"required-after:artifacts;",
		acceptedMinecraftVersions = "[1.12.2]", updateJSON = Treasure.UPDATE_JSON_URL)
